...
using namespace cv;
const char* keys =
//"{ help  h | No need! | Print help message. }"
"{ @input1 | Histogram_Comparison_Source_0.jpg | input1 }"
"{ @input2 | Histogram_Comparison_Source_1.jpg | input2 }"
"{ @input3 | Histogram_Comparison_Source_2.jpg | input3 }";
